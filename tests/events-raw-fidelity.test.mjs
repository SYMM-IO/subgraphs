...
const releaseOnlyPayloads = {
	...
	CloseSolverFeeCharged: ["quoteId", "partyA", "partyB", "symbolId", "amount"],
	...
	OpenSolverFeeCharged: ["quoteId", "partyA", "partyB", "symbolId", "amount"],
	...
	SetMuonFunctionUpnlValidTime: ["func", "enabled", "upnlValidTime"],
...
test("release ABI drops the removed affiliate pause event", () => {
	...
	assert.equal(
		...
		"cdd6e9db666b65e6097d331e91529c3800b54cf0f1d289d47f6267549a3f9d29",
