...
export function getDailyHistoryForTimestamp(timestamp: BigInt, account: Bytes, accountSource: Bytes | null): DailyHistory {
...
export function getTotalHistory(timestamp: BigInt, account: Bytes, accountSource: Bytes | null): TotalHistory {
