...
const VERSIONS_HASH = "allocate_party_a:v1|buyback:v1|buyback_day:v1|buyback_deposit:v1|buyback_gateway_stats:v1|deallocate_party_a:v1|deposit:v1|force_close_position:v1|request_to_cancel_close_request:v1|request_to_cancel_quote:v1|request_to_close_position:v1|role_granted:v2|role_revoked:v2|send_quote:v2|withdraw:v1"
...
export function ensureSyncMeta(block: ethereum.Block): void {
    ...
    ensureEntityVersion("role_granted", "v2", block.timestamp)
    ensureEntityVersion("role_revoked", "v2", block.timestamp)
