...
/**
 * Applies the metadata shared by every immutable raw Express Provider event entity.
 * Event-specific handlers remain responsible for payload fields and saving.
 */
export function setRawExpressProviderEventMetadata(entity: Entity, event: ethereum.Event): void {
