...
export function getQuote(address: Address, id: BigInt): symmio_0_8_5__getQuoteResultValue0Struct | null {
...
export function getLiquidatedStateOfPartyA(address: Address, partyA: Address): symmio_0_8_5__getLiquidatedStateOfPartyAResultValue0Struct | null {
	const contract = symmio_0_8_5.bind(address)
	let result = contract.try_getLiquidatedStateOfPartyA(partyA)
	return result.reverted ? null : result.value
}

export function getBalanceInfoOfPartyA(address: Address, partyA: Address): symmio_0_8_5__balanceInfoOfPartyAResult | null {
	const contract = symmio_0_8_5.bind(address)
...
export function symbolIdToSymbolName(symbolId: BigInt, contractAddress: Address): string {
	let symmioContract = symmio_0_8_5.bind(contractAddress)
