...
import {EmergencyClosePosition as EmergencyClosePosition_0_8_5} from "../../../../generated/symmio_0_8_5/symmio_0_8_5";
	...
	handle(_event: ethereum.Event, version: Version): void {
		...
		switch (version) {
			case Version.v_0_8_5: {
				handleClose<EmergencyClosePosition_0_8_5>(event, "EmergencyClosePosition", version)
				break
			}
